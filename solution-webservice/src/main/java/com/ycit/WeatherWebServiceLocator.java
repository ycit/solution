...
public class WeatherWebServiceLocator extends org.apache.axis.client.Service implements com.ycit.WeatherWebService {
 ...
 */
    ...
    public com.ycit.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.ycit.WeatherWebServiceSoap_PortType getWeatherWebServiceSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.ycit.WeatherWebServiceSoap_BindingStub _stub = new com.ycit.WeatherWebServiceSoap_BindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.ycit.WeatherWebServiceSoap_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.ycit.WeatherWebServiceSoap_BindingStub _stub = new com.ycit.WeatherWebServiceSoap_BindingStub(new java.net.URL(WeatherWebServiceSoap_address), this);
                _stub.setPortName(getWeatherWebServiceSoapWSDDServiceName());
                return _stub;
            }
        }
