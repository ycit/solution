 ...
 * @date 2019/7/30
 */
public class SnowFlakeIdGeneratorUpgrade {
...
//上次生成ID的时间截
    ...
    public SnowFlakeIdGeneratorUpgrade(long workerId, long dataCenterId) {
...
//                | (workerId << WORKERID_OFFSET)
    ...
    public static void main(String[] args) {
        ...
        final SnowFlakeIdGeneratorUpgrade idGenerator = new SnowFlakeIdGeneratorUpgrade(1, 1);
